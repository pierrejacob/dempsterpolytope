...
gconstraints <- gconstraints + geom_label(data = data.frame(x = 0.85, y = 0.4, label = TeX("$\\theta_1/\\theta_3 = \\eta_{3\\rightarrow 1}$", output = "character")), 
                                          aes(x = x, y = y, label = label), parse = TRUE, col = contcols[3], alpha = 0.75, size = labelsize)
gconstraints <- gconstraints + geom_label(data = data.frame(x = 0.15, y = 0.2, label = TeX("$\\theta_2/\\theta_1 = \\eta_{1\\rightarrow 2}$", output = "character")), 
                                          aes(x = x, y = y, label = label), parse = TRUE, col = contcols[1], alpha = 0.75, size = labelsize)
gconstraints <- gconstraints + geom_label(data = data.frame(x = 0.85, y = 0.18, label = TeX("$\\theta_3/\\theta_1 = \\eta_{1\\rightarrow 3}$", output = "character")), 
                                          aes(x = x, y = y, label = label), parse = TRUE, col = contcols[1], alpha = 0.75, size = labelsize)
gconstraints
...
g <- g + annotate(geom = "label", x = 0.15, y = 0.55, label = TeX("$\\log(\\eta_{1\\rightarrow 2})$"), size = labelsize, col = contcols[1])
g <- g + annotate(geom = "label", x = 0.3, y = 0.35, label = TeX("$\\log(\\eta_{2\\rightarrow 1})$"), size = labelsize, col = contcols[2])
g <- g + annotate(geom = "label", x = 0.85, y = 0.55, label = TeX("$\\log(\\eta_{3\\rightarrow 1})$"), size = labelsize, col = contcols[3])
g <- g + annotate(geom = "label", x = 0.7, y = 0.35, label = TeX("$\\log(\\eta_{1\\rightarrow 3})$"), size = labelsize, col = contcols[1])
